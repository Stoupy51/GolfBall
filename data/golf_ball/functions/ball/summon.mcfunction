...
summon pig ~ ~ ~ {Tags:["golf_ball.base","golf_ball.new"],Invulnerable:1b,Silent:1b,Age:-200000,Passengers:[{id:"minecraft:item_display",Tags:["golf_ball.display","golf_ball.new"],item_display:"ground",transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,-0.36f,0f],scale:[1f,1f,1f]},item:{id:"minecraft:emerald_block",Count:1b}}],active_effects:[{id:"minecraft:invisibility",amplifier:0b,duration:-1,show_particles:0b}],Attributes:[{Name:"generic.movement_speed",Base:0.00d}]}
