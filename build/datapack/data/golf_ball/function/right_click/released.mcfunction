...
execute on vehicle if entity @s[tag=golf_ball.legacy] run scoreboard players operation @s golf_ball.motion_x += #motion_x golf_ball.data
execute on vehicle if entity @s[tag=golf_ball.legacy] run scoreboard players operation @s golf_ball.motion_z += #motion_z golf_ball.data
...
execute on vehicle unless entity @s[tag=golf_ball.legacy] store result score #temp golf_ball.data run data get entity @s Motion[0] 1000000
execute on vehicle unless entity @s[tag=golf_ball.legacy] run scoreboard players operation #motion_x golf_ball.data += #temp golf_ball.data
execute on vehicle unless entity @s[tag=golf_ball.legacy] store result entity @s Motion[0] double 0.000001 run scoreboard players get #motion_x golf_ball.data
execute on vehicle unless entity @s[tag=golf_ball.legacy] store result score #temp golf_ball.data run data get entity @s Motion[2] 1000000
execute on vehicle unless entity @s[tag=golf_ball.legacy] run scoreboard players operation #motion_z golf_ball.data += #temp golf_ball.data
execute on vehicle unless entity @s[tag=golf_ball.legacy] store result entity @s Motion[2] double 0.000001 run scoreboard players get #motion_z golf_ball.data
