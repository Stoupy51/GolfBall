...
execute unless data entity @s equipment.offhand.components."minecraft:custom_data".golf_ball run item replace entity @s weapon.offhand with stone[item_model="air",item_name={"text":"Right Click Detection","color":"gray"},custom_data={golf_ball:1b},enchantments={"golf_ball:invulnerable":1},attribute_modifiers=[{"id":"golf_ball:block_interaction_range","type":"block_interaction_range",amount:-1024,operation:"add_value",slot:"any"}],consumable={consume_seconds:1000000}]
