...
#> golf_ball:v1.4.5/load/enumerate
#
...
execute if score #golf_ball.major load.status matches 1 if score #golf_ball.minor load.status matches 4 unless score #golf_ball.patch load.status matches 5.. run scoreboard players set #golf_ball.patch load.status 5
